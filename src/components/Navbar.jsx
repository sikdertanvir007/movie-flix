...
<div>{user && user.email}</div>
        ...
        <div className="navbar-end">
          {
            user ? (<button onClick={handleLogOut} className='btn btn-primary btn-outline'>LogOut</button>) : ( <Link to="/auth/login" className="btn btn-primary btn-outline">Login</Link>)
          }
